...
- 新增 `references/reviewer-style-profile.md`：梁月十三律师审查风格档案，包含高频触发点、标准条款偏好、批注语气规范
- SKILL.md 风险等级体系由 P0/P1/P2 全面替换为 S/A/B/C 四级（禁止使用 P0/P1/P2）
- Reference 调用结构由四层升级为五层，风格档案置于最高优先级
- 审查结论谈判优先级改为 S → A → B → C

### 校准要点

- 付款条款：三段式付款 + 财政拨付延迟免责（政府合同标配）
- 验收条款：签收单≠验收合格 + 隐蔽瑕疵保留权（采购合同标配）
- 违约责任：万分之五/日 + 超5日解除权 + 扣款权
- AI合规风险：AIGC、深度合成、舆情AI功能需专项批注
- 未成年人保护：涉及未成年人活动必须补充保护条款
